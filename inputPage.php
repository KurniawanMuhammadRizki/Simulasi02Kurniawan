...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white text-uppercase mb-3 animated slideInDown">Input Nilai</h1>
        ...
        <form action="input.php" method="POST">
            ...
            <div class="col-12">
                <div class="form-floating">
                    <input type="text" class="form-control bg-transparent" name="nim" placeholder="Nomor Induk Mahasiswa">
                    <label for="name">Nomor Induk Mahasiswa</label>
                </div>
            </div>
            <div class="col-12">
                <div class="form-floating">
                    <input type="text" class="form-control bg-transparent" name="nama" placeholder="Nama Mahasiswa">
                    <label for="name">Nama Mahasiswa</label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-floating">
                    <input type="number" class="form-control bg-transparent" name="tugas" placeholder="Rata-Rata Tugas">
                    <label for="name">Rata-Rata Tugas</label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-floating">
                    <input type="number" class="form-control bg-transparent" name="uts" placeholder="Nilai Ujian Tengah Semester">
                    <label for="name">Nilai Ujian Tengah Semester</label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-floating">
                    <input type="number" class="form-control bg-transparent" name="uas" placeholder="Nilai Ujian Akhir Semester">
                    <label for="name">Nilai Ujian Akhir Semester</label>
                </div>
            </div>
            <div class="col-12">
                <button class="btn btn-primary w-100 py-3" type="submit">Input Nilai</button>
            </div>
            </div>
            </form>
