...
$sql = "SELECT nim,nama,tugas,uts,uas FROM mhs WHERE nim = '$nim' ";
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <table border="1" class=" table-floating col-12 table-control bg-transparent">
                ...
                <tr>
                <td>
                    <input class="table-control bg-transparent" type="text" name="nim" placeholder="Nomor Induk Mahasiswa" value="<?php echo ": ".$row ['nim'];?>"readonly >
                </td>
                <td>
                    <input class="table-control bg-transparent" type="text" name="nama" placeholder="Nama Lengkap Mahasiswa" value="<?php echo ": ".$row ['nama'];?>" >
                </td>
                <td>
                    <input class="table-control bg-transparent" type="number" name="tugas" placeholder="Nilai Rata-Rata Tugas" value="<?php echo ": ".$row ['tugas'];?>" >
                </td>
                <td> 
                    <input class="table-control bg-transparent" type="number" name="uts" placeholder="Nilai Ujuan Tengah Semester" value="<?php echo ": ".$row ['uts'];?>" >
                </td>
                <td>
                    <input class="table-control bg-transparent" type="number" name="uts" placeholder="Nilai Ujuan Tengah Semester" value="<?php echo ": ".$row ['uas'];?>" >
                </td>
                <td>
                    <a href="">Edit Nilai</a> | <a href="">Hapus Nilai</a>
                </td>
                </tr>
            </table>
        </div>
